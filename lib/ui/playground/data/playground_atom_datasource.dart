...
class PlayGroundAtomDataSource implements PlaygroundDataSource {
  ...
  List<Widget> getList() {
    return [
      ...
      StandardListItem(
          viewModel: ArticleListItemViewModelTransformer.buildWithDetail(
      ...
      PlaygroundWidget(
        ...
        child: Container(
          ...
          child: const Text(
            'RecordTransaction widgets require a parent state and are disabled in this playground example.',
